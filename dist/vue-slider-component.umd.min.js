;(function(t, e) {
  ...
  return (function(t) {
    ...
    fb15: function(t, e, r) {
      ...
      function l(t, e) {
        return (
          ...
          Object(a['createDecorator'])(function(r, n) {
            ;((r.props || (r.props = {}))[n] = e), (r.model = { prop: n, event: t || n })
          })
        )
      }
      function c(t) {
      ...
      var x = (function(t) {
        function e() {
          return p(this, e), v(this, b(e).apply(this, arguments))
        }
        return (
          g(e, t),
          y(e, [
            ...
            },
            {
              ...
              get: function() {
                return [
                  'vue-slider-dot',
                  { 'vue-slider-dot-disabled': this.disabled, 'vue-slider-dot-focus': this.focus },
                ]
              },
            },
            {
      ...
      o([c({ default: 0 })], x.prototype, 'value', void 0),
        o([c()], x.prototype, 'tooltip', void 0),
        o([c()], x.prototype, 'dotStyle', void 0),
        o([c()], x.prototype, 'tooltipStyle', void 0),
        o(
          [
            c({
              type: String,
        ...
        o([c({ type: [String, Function] })], x.prototype, 'tooltipFormatter', void 0),
        o([c({ type: Boolean, default: !1 })], x.prototype, 'focus', void 0),
        o([c({ default: !1 })], x.prototype, 'disabled', void 0),
        (x = o([u.a], x))
      var w = x
      r('556c')
      function O(t) {
      ...
      function R(t, e) {
        return !e || ('object' !== O(e) && 'function' !== typeof e) ? D(t) : e
      }
      function D(t) {
        if (void 0 === t)
          throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
      ...
      var _ = (function(t) {
        function e() {
          return P(this, e), R(this, A(e).apply(this, arguments))
        }
        return (
          j(e, t),
          E(e, [
      ...
      o([c({ required: !0 })], _.prototype, 'mark', void 0),
        o([c(Boolean)], _.prototype, 'hideLabel', void 0),
        o([c()], _.prototype, 'stepStyle', void 0),
        o([c()], _.prototype, 'stepActiveStyle', void 0),
        o([c()], _.prototype, 'labelStyle', void 0),
        o([c()], _.prototype, 'labelActiveStyle', void 0),
        (_ = o([u.a], _))
      var C,
        M = _,
        T = function(t) {
      ...
      var ot = ((U = {}),
        nt(U, F.VALUE, 'The type of the "value" is illegal'),
        nt(
          U,
          F.INTERVAL,
          'The prop "interval" is invalid, "(max - min)" cannot be divisible by "interval"',
        ),
        nt(U, F.MIN, 'The "value" cannot be less than the minimum.'),
        nt(U, F.MAX, 'The "value" cannot be greater than the maximum.'),
        nt(
          U,
          F.ORDER,
          ...
          return (
            rt(t, [
              ...
              },
              {
                ...
                value: function(t) {
                  if (this.data) t = this.data.indexOf(t)
                    ...
                    if (((t = +t), t < this.min)) return this.emitError(F.MIN), 0
                  ...
                  var e = new $(t).multiply(this.gap).toNumber()
              ...
              },
              {
                key: 'emitError',
                value: function(t) {
                  this.onError && this.onError(t, ot[t])
                },
              },
              {
                key: 'getDotRange',
                  ...
                  return (
                    (t = this.data
                      ...
                      : new $(this.max)
                          ...
                          .divide(this.interval)
                          .toNumber()),
                    t - Math.floor(t) !== 0 ? (this.emitError(F.INTERVAL), 0) : t
                  )
                },
              },
              {
      ...
      var lt = (function() {
        function t(e) {
          st(this, t), (this.states = 0), (this.map = e)
        }
        return (
          ut(t, [
            {
      ...
      function Pt(t, e) {
        return !e || ('object' !== ct(e) && 'function' !== typeof e) ? St(t) : e
      }
      function St(t) {
        if (void 0 === t)
          throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
      ...
      var At = { None: 0, Drag: 1, Focus: 2 },
        ...
        Vt = (function(t) {
          function e() {
            ...
            return (
              xt(this, e),
              (t = Pt(this, Et(e).apply(this, arguments))),
              (t.states = new lt(At)),
              (t.scale = 1),
              (t.focusDotIndex = 0),
              t
            ...
            Ot(e, [
              {
                key: 'onValueChanged',
                value: function() {
                  !this.states.has(At.Drag) && this.isNotSync && this.control.setValue(this.value)
                },
              },
              {
                key: 'created',
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this.isDiff(t, Array.isArray(this.value) ? this.value : [this.value]) &&
                    this.$emit('change', 1 === t.length ? t[0] : mt(t))
                },
              },
              {
                key: 'isDiff',
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  this.$emit('dragging', 1 === r.length ? r[0] : mt(r))
                },
              },
              {
                key: 'isCrossDot',
                  ...
                  this.lazy && this.syncValueByPos(),
                    setTimeout(function() {
                      t.included && t.isNotSync
                        ...
                        : t.control.syncDotsPos(),
                        t.states.delete(At.Drag),
                        t.useKeyboard || t.states.delete(At.Focus),
                        t.$emit('drag-end')
                    })
                },
              },
              ...
              },
              {
                key: 'clickHandle',
                value: function(t) {
                  var e = this.lastClickTime
                  if (((this.lastClickTime = Date.now()), this.doubleClickable)) {
                    if (Date.now() - e < 300) {
                      this.setScale()
                      var r = this.getPosByEvent(t)
                      this.$emit('double-click', r)
                    }
                  } else {
                    if (!this.clickable) return !1
                    if (!this.states.has(At.Drag)) {
                      this.setScale()
                      var n = this.getPosByEvent(t)
                      this.setValueByPos(n)
                    }
                  }
                },
              },
              {
                ...
                value: function() {
                  ...
                  this.states.add(At.Focus), (this.focusDotIndex = t)
                },
              },
              {
                key: 'blur',
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  var e = I(t, { direction: this.direction, max: this.control.total, min: 0 })
                  if (e) {
                    t.preventDefault()
              ...
              },
              {
                key: 'getPosByEvent',
                value: function(t) {
                  return N(t, this.$el, this.isReverse)[this.isHorizontal ? 'x' : 'y'] / this.scale
                },
              },
              {
                key: 'renderSlot',
                                ...
                                return t.renderSlot(
                                  ...
                                  e(
                                    'vue-slider-mark',
                                    {
                                      ...
                                      style: ((o = {}),
                                      vt(o, t.isHorizontal ? 'height' : 'width', '100%'),
                                      vt(o, t.isHorizontal ? 'width' : 'height', t.tailSize),
                                      vt(o, t.mainDirection, ''.concat(r.pos, '%')),
                                      o),
                                      on: {
                                    ...
                                    [t.renderSlot('step', r, null), t.renderSlot('label', r, null)],
                                  ),
                                  !0,
                                )
                              }),
              ...
              },
              {
                key: 'tailSize',
                get: function() {
                  return T((this.isHorizontal ? this.height : this.width) || jt)
                },
              },
              {
              ...
              },
              {
                ...
                get: function() {
                  var t = Array.isArray(this.dotSize) ? this.dotSize : [this.dotSize, this.dotSize],
                    ...
                    r = e[0],
                    n = e[1],
                    o = this.width ? T(this.width) : this.isHorizontal ? 'auto' : T(jt),
                    i = this.height ? T(this.height) : this.isHorizontal ? T(jt) : 'auto'
                  return {
                ...
                get: function() {
                  ...
                  return this.control.processArray.map(function(e) {
                    ...
                    return {
                      ...
                      style: dt(
                        ((r = {}),
                        vt(r, t.isHorizontal ? 'height' : 'width', '100%'),
                        vt(r, t.isHorizontal ? 'top' : 'left', 0),
                        vt(r, t.mainDirection, ''.concat(o, '%')),
                        vt(r, u, ''.concat(i - o, '%')),
                        vt(r, 'transitionProperty', ''.concat(u, ',').concat(t.mainDirection)),
                        vt(r, 'transitionDuration', ''.concat(t.animateTime, 's')),
                        r),
                        t.processStyle,
                        s,
                      ),
              ...
              },
              {
                ...
                get: function() {
                  ...
                  return (
                    ...
                    dt({ width: ''.concat(n, 'px'), height: ''.concat(o, 'px') }, t)
                  )
                },
              },
              {
      ...
      o([l('change', { default: 0 })], Vt.prototype, 'value', void 0),
        o([c({ type: Boolean, default: !1 })], Vt.prototype, 'silent', void 0),
        o(
          [
            c({
              default: 'ltr',
        ...
        o([c({ type: [Number, String] })], Vt.prototype, 'width', void 0),
        o([c({ type: [Number, String] })], Vt.prototype, 'height', void 0),
        o([c({ default: 14 })], Vt.prototype, 'dotSize', void 0),
        o([c({ default: !1 })], Vt.prototype, 'contained', void 0),
        o([c({ type: Number, default: 0 })], Vt.prototype, 'min', void 0),
        o([c({ type: Number, default: 100 })], Vt.prototype, 'max', void 0),
        o([c({ type: Number, default: 1 })], Vt.prototype, 'interval', void 0),
        o([c({ type: Boolean, default: !1 })], Vt.prototype, 'disabled', void 0),
        o([c({ type: Boolean, default: !0 })], Vt.prototype, 'clickable', void 0),
        o([c({ type: Boolean, default: !1 })], Vt.prototype, 'doubleClickable', void 0),
        o([c({ type: Number, default: 0.5 })], Vt.prototype, 'duration', void 0),
        o([c(Array)], Vt.prototype, 'data', void 0),
        o([c({ type: Boolean, default: !1 })], Vt.prototype, 'lazy', void 0),
        o(
          [
            c({
              type: String,
        ...
        o([c({ type: [String, Array, Function] })], Vt.prototype, 'tooltipFormatter', void 0),
        o([c({ type: Boolean, default: !1 })], Vt.prototype, 'useKeyboard', void 0),
        o([c({ type: Boolean, default: !0 })], Vt.prototype, 'enableCross', void 0),
        o([c({ type: Boolean, default: !1 })], Vt.prototype, 'fixed', void 0),
        o([c({ type: Boolean, default: !0 })], Vt.prototype, 'order', void 0),
        o([c(Number)], Vt.prototype, 'minRange', void 0),
        o([c(Number)], Vt.prototype, 'maxRange', void 0),
        o(
          [c({ type: [Boolean, Object, Array, Function], default: !1 })],
          Vt.prototype,
          'marks',
          void 0,
        ),
        o([c({ type: [Boolean, Function], default: !0 })], Vt.prototype, 'process', void 0),
        o([c(Boolean)], Vt.prototype, 'included', void 0),
        o([c(Boolean)], Vt.prototype, 'adsorb', void 0),
        o([c(Boolean)], Vt.prototype, 'hideLabel', void 0),
        o([c()], Vt.prototype, 'dotOptions', void 0),
        o([c()], Vt.prototype, 'railStyle', void 0),
        o([c()], Vt.prototype, 'processStyle', void 0),
        o([c()], Vt.prototype, 'dotStyle', void 0),
        o([c()], Vt.prototype, 'tooltipStyle', void 0),
        o([c()], Vt.prototype, 'stepStyle', void 0),
        o([c()], Vt.prototype, 'stepActiveStyle', void 0),
        o([c()], Vt.prototype, 'labelStyle', void 0),
        o([c()], Vt.prototype, 'labelActiveStyle', void 0),
        o([d('value')], Vt.prototype, 'onValueChanged', null),
        (Vt = o(
          [
            u()({
              data: function() {
                return { control: null, lastClickTime: 0 }
              },
              components: { VueSliderDot: w, VueSliderMark: M },
              inheritAttrs: !1,
            }),
          ],
          Vt,
