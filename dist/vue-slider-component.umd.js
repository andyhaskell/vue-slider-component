...
*/
      ...
      /***/ ae61: /***/ function(module, exports, __webpack_require__) {
      ...
      /***/ d5ac: /***/ function(module, exports, __webpack_require__) {
        exports = module.exports = __webpack_require__('2350')(false)
        // imports
      ...
      /***/ df80: /***/ function(module, exports, __webpack_require__) {
        exports = module.exports = __webpack_require__('2350')(false)
        // imports
...
***************************************************************************** */
        ...
        var VueSlideMark =
          ...
          (function(_Vue) {
            ...
            function VueSlideMark() {
              ...
              return vue_slider_mark_possibleConstructorReturn(
                this,
                vue_slider_mark_getPrototypeOf(VueSlideMark).apply(this, arguments),
              )
            }
            ...
            control_createClass(Control, [
              {
                ...
                value: function setValue(value) {
                  this.setDotsValue(
                    Array.isArray(value) ? _toConsumableArray(value) : [value],
                    true,
                  )
                },
              },
        ...
        var vue_slider_VueSlider =
          ...
          (function(_Vue) {
            ...
            function VueSlider() {
              ...
              _this = vue_slider_possibleConstructorReturn(
                this,
                vue_slider_getPrototypeOf(VueSlider).apply(this, arguments),
              )
            ...
            vue_slider_createClass(VueSlider, [
                ...
                value: function initControl() {
                  ...
                  ;[
                    ...
                    _this2.$watch(name, function(val) {
                      if (
                        name === 'data' &&
                        Array.isArray(_this2.control.data) &&
                        Array.isArray(val) &&
                        _this2.control.data.length === val.length &&
              ...
              },
              {
                ...
                value: function clickHandle(e) {
                  var oldLastClickTime = this.lastClickTime
                  ...
                  if (this.doubleClickable) {
                    if (Date.now() - oldLastClickTime < 300) {
                      ...
                      var _pos = this.getPosByEvent(e)

                      this.$emit('double-click', _pos)
                    }
                            ...
                            return h(
                              'vue-slider-dot',
                              {
                                ...
                                attrs: {
                                  ...
                                  'tooltip-formatter': Array.isArray(_this6.tooltipFormatter)
                                    ? _this6.tooltipFormatter[index]
                                    : _this6.tooltipFormatter,
              ...
              },
              {
                key: 'containerStyles',
                get: function get() {
                  var _ref2 = Array.isArray(this.dotSize)
                      ? this.dotSize
                  ...
                  return this.control.processArray.map(function(_ref4) {
                    ...
                    return {
                      ...
                      style: vue_slider_objectSpread(
                        ...
                        vue_slider_defineProperty(
                          _objectSpread2,
                          _this7.isHorizontal ? 'top' : 'left',
                          0,
                        ),
                        vue_slider_defineProperty(
                          _objectSpread2,
                          _this7.mainDirection,
                          ''.concat(start, '%'),
                        ),
                        vue_slider_defineProperty(
                          _objectSpread2,
              ...
              },
              {
                key: 'dotBaseStyle',
                get: function get() {
                  var _ref7 = Array.isArray(this.dotSize)
                      ? this.dotSize
                      : [this.dotSize, this.dotSize],
                    ...
                    return vue_slider_objectSpread(
                      {
                        ...
                        focus:
                          _this8.states.has(SliderState.Focus) && _this8.focusDotIndex === index,
                        disabled: false,
        ...
        /* concated harmony reexport ERROR_TYPE */ __webpack_require__.d(
          __webpack_exports__,
          'ERROR_TYPE',
          function() {
            return ERROR_TYPE
